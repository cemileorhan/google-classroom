    ...
    public class ClassroomController : Controller
    {
        ...
        public IActionResult Index(int? id)
        {
            ...
            ViewBag.ApplicationUserRole = db.ClassUser
                .FirstOrDefault(cu => cu.ApplicationUserId == userId && cu.ClassRoomId == id).Roles; //true teacher, false student
            ...
            var nearestHomework = allHomeworks
                .OrderBy(hw => Math.Abs((hw.DueDate - DateTime.Now).Ticks)) 
                .FirstOrDefault();
        ...
        public IActionResult Archived(int? id)
        {
            ...
            ViewBag.ApplicationUserRole = db.ClassUser
                .FirstOrDefault(cu => cu.ApplicationUserId == userId && cu.ClassRoomId == id).Roles; 
